...
export default class UpdateScreen extends Component {
    ...
    render() {
        ...
        let { fieldError, completed, title, id  } = this.props;
        return (
            <Container>
                <Header>
                    <Left>
                ...
                <Form>
                    ...
                    <Item>
                        <Label>Title</Label>
                        <Input onChangeText={(val) => this.props.handleInputChange(val, 'title')} value={title}  />
                    </Item>
                    <Item>
                ...
                <Button block style={{ margin: 15, marginTop: 50 }} onPress={this.props.updateItem}>
                    <Text>UPDATE</Text>
                </Button>
